...
const experiences = [
  {
    ...
    technologies: ["Java", "Spring Boot", "Node.js", "TypeScript", "RabbitMQ", "Docker", "Podman", "GitLab CI/CD", "JUnit", "Jest"],
    highlights: [
      ...
      "Developed automated tests using JUnit for Java services and Jest for Node.js",
    ],
  },
  {
    ...
    description: "Implemented observability and monitoring with Datadog, improving system visibility, alerting, and incident response. Collaborated with cross-functional and international teams to ensure secure, compliant, and scalable identity provisioning workflows.",
    technologies: ["Datadog", "GitLab Duo", "Oracle SOA Suite", "OSB", "ODI", "Java Spring Boot", "Git", "CI/CD"],
    highlights: [
